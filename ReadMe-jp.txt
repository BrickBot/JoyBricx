========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : JoyBricx
========================================================================


AppWizard が生成した JoyBricx には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには JoyBricx を構成している各ファイルの概要説明が含まれています。
...
JoyBricx.h
    ...
    みます） をインクルードし、また CJoyBricxApp アプリケーションクラスを宣
    言します。

JoyBricx.cpp
    このファイルは CJoyBricxApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\JoyBricx.ico
    ...
    ルです。このアイコンはリソース ファイル JoyBricx.rc によってインクルード
    されます。
...
JoyBricxDlg.h, JoyBricxDlg.cpp - ダイアログ
    これらのファイルは CJoyBricxDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な JoyBricx.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) JoyBricx.pch 
